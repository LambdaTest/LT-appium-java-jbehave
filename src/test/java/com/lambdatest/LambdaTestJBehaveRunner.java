...
@RunWith(Parameterized.class) public class LambdaTestJBehaveRunner {
  ...
  @Parameter(value = 0) public int taskID;
  ...
  public void setUp() throws Exception {
    ...
    String username = System.getenv("LT_USERNAME") == null ?
      "YOUR_LT_USERNAME" :
      System.getenv("LT_USERNAME");  //Replace YOUR_LT_USERNAME with your LambdaTest username

    String accessKey = System.getenv("LT_ACCESS_KEY") == null ?
      "YOUR_LT_ACCESS_KEY" :
      System.getenv("LT_ACCESS_KEY"); //Replace YOUR_LT_ACCESS_KEY with your LambdaTest accessKey
